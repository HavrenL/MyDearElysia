...
sys.path.insert(0, "%s/GPT_SoVITS/GPT_SoVITS" % (now_dir))
sys.path.append("%s/GPT_SoVITS" % (now_dir))
sys.path.append("%s/GPT_SoVITS/GPT_SoVITS/eres2net" % (now_dir))

# 将项目内的 ffmpeg 加入 PATH，确保 TTS 音频解码能找到 ffmpeg
ffmpeg_bin = "%s/ffmpeg/bin" % (now_dir)
